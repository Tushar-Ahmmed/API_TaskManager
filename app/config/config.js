...
export const DATABASE = "mongodb+srv://tushar:123@module17.dfr5l.mongodb.net/"

export const JWT_KEY = "ABC145276352"
export const JWT_EXPIRE_TIME = 30 * 24 * 60 * 60

export const EMAIL_HOST = "mail.teamrabbil.com"
export const EMAIL_PORT = 25
export const EMAIL_ECURITY = false
...
export const REQUEST_TIME = 20 * 60 * 60 * 1000
export const REQUEST_NUMBER = 20 * 60 * 60 * 1000
